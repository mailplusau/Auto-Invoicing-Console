...
function onclick_summaryPage() {
	...
	var upload_url = baseURL + nlapiResolveURL('SUITELET', 'customscript_sl_summary_page', 'customdeploy_summary_page') + '&start_date=' + nlapiGetFieldValue('start_date') + '&end_date=' + nlapiGetFieldValue('end_date');
	window.open(upload_url, "_self", "height=750,width=650,modal=yes,alwaysRaised=yes");
}
